...
# Deux regles apprises sur les executions reelles :
# 1. DEUX MOTS MAXIMUM. Google News fait de la correspondance stricte :
#    "banque centrale" rend 30 articles, "oil price OPEC crude supply" en rend 0.
# 2. JAMAIS LE MEME SUJET DANS DEUX LANGUES. "sanctions" en francais et en anglais
#    ramenaient les memes evenements sous des titres qui ne partagent aucun mot :
#    impossible a regrouper, d'ou 393 articles pour 300 dossiers.
#    Chaque requete couvre donc un ANGLE different, pas une traduction.
THEMES = {
    "macro": {
    ...
    "energie": {
        ...
        "rss": [
            ...
            _google_news("refinery", "en"),
            _google_news("LNG shipping", "en"),
        ],
    },
    "defense": {
        ...
        "rss": [
            ...
            _google_news("defense spending", "en"),
            _google_news("NATO", "en"),
        ],
    },
    "tech": {
